"""
---------------- CREAR AUTOMÁTICAMENTE LA ETIQUETA CORRESPONDIENTE AL EXPERIMENTO LANZADO -------------------
...
class SimulationLabeler:
    ...
    def _check_instability(self, gam, om_r, gam_var, om_r_var):
        """Comprobar umbrales de inestabilidad."""
    ...
    def _clean_mode_str(self, raw_str):
        """Extrae el m y n puros de cadenas como 'R  3/ 2' o 'I 10/3'"""
    ...
    def _get_dominant_modes(self, df_phi, umbral_acoplamiento=0.5):
        """
        Obtener el modo dominante (m/n, m, n, pos_radial_max, diff).
    ...
    def _process_continuum(self, df_continuo, r_max, n_val):
        """
        Aproximar radio, filtrar por 'n', y obtener lista ordenada de frecuencias del gap.
        """
    ...
    def _classify_in_gaps(self, om_r, ramas_limpias, r_max, r_qmin, min_continuo_global, diff):
        """
        Asignar etiqueta cruzando frecuencia con la lista de ramas y las reglas GAE/RSAE.
        """
    ...
    def generate_label(self, escalares, df_phi, df_continuo, df_prof):
        ...
        # 5. Tipo de Inestabilidad AE (si hay)

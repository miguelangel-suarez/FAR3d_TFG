...
# ---------------------------------------------------------
# 1. FUNCIÓN DEL TRABAJADOR (Ejecutada en paralelo)
# ---------------------------------------------------------
def worker_simulacion_por_n(n, mm_vals, combinaciones, all_keys, len_input, template_dir, csv_continuo):
    ...
    Trabaja en su propia carpeta aislada.
    """
...
def main():
    ...
    # max_workers=5 porque tenemos 5 valores de 'n' (1, 2, 3, 4, 5)
    with concurrent.futures.ProcessPoolExecutor(max_workers=5) as executor:
        futuros = []

        # Enviamos un worker independiente por cada valor de 'n'
        for n in nn:
            modos_m = dicc_nm[n]
            # Sometemos la tarea al pool de procesos
...
# MUY IMPORTANTE PARA MULTIPROCESSING EN PYTHON (WINDOWS ESPECIALMENTE)

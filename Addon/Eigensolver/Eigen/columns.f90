...
!	Format of the external file 	
    ...
    open(unit=33,file="egn_mode_asci_GR=0.1_FR=0.25.dat",status="old")
    read(33,*) nmat
    read(33,*) mn_col
    read(33,*) ns   
...
!	output format and file output 	
	...
	do m=1,ns	
	      write(2,formatw) rho(m),t,egn_vectors(1,1,m),t,egn_vectors(1,2,m),t,egn_vectors(1,3,m),t, &  
                         ...
                         egn_vectors(1,8,m),t,egn_vectors(1,9,m),t,egn_vectors(1,10,m),t,egn_vectors(1,11,m),t, &
                         egn_vectors(1,12,m),t,egn_vectors(1,13,m),t,egn_vectors(1,14,m)
	end do
        close(2)	
	...
	do m=1,ns	
	      write(3,formatw) rho(m),t,egn_vectors(2,1,m),t,egn_vectors(2,2,m),t,egn_vectors(2,3,m),t, &  
                         ...
                         egn_vectors(2,8,m),t,egn_vectors(2,9,m),t,egn_vectors(2,10,m),t,egn_vectors(2,11,m),t, &
                         egn_vectors(2,12,m),t,egn_vectors(2,13,m),t,egn_vectors(2,14,m)  
	end do
        close(3)	
	...
	do m=1,ns	
	      write(4,formatw) rho(m),t,egn_vectors(3,1,m),t,egn_vectors(3,2,m),t,egn_vectors(3,3,m),t, &  
                         ...
                         egn_vectors(3,8,m),t,egn_vectors(3,9,m),t,egn_vectors(3,10,m),t,egn_vectors(3,11,m),t, &
                         egn_vectors(3,12,m),t,egn_vectors(3,13,m),t,egn_vectors(3,14,m)
	end do
        close(4)	
	...
	do m=1,ns	
	      write(5,formatw) rho(m),t,egn_vectors(4,1,m),t,egn_vectors(4,2,m),t,egn_vectors(4,3,m),t, &  
                         ...
                         egn_vectors(4,8,m),t,egn_vectors(4,9,m),t,egn_vectors(4,10,m),t,egn_vectors(4,11,m),t, &
                         egn_vectors(4,12,m),t,egn_vectors(4,13,m),t,egn_vectors(4,14,m) 
	end do
        close(5)
	...
	do m=1,ns	
	      write(6,formatw) rho(m),t,egn_vectors(5,1,m),t,egn_vectors(5,2,m),t,egn_vectors(5,3,m),t, &  
                         ...
                         egn_vectors(5,8,m),t,egn_vectors(5,9,m),t,egn_vectors(5,10,m),t,egn_vectors(5,11,m),t, &
                         egn_vectors(5,12,m),t,egn_vectors(5,13,m),t,egn_vectors(5,14,m) 
	end do
        close(6)
	...
	do m=1,ns	
	      write(7,formatw) rho(m),t,egn_vectors(6,1,m),t,egn_vectors(6,2,m),t,egn_vectors(6,3,m),t, &  
                         ...
                         egn_vectors(6,8,m),t,egn_vectors(6,9,m),t,egn_vectors(6,10,m),t,egn_vectors(6,11,m),t, &
                         egn_vectors(6,12,m),t,egn_vectors(6,13,m),t,egn_vectors(6,14,m)
	end do
        close(7)
	...
	do m=1,ns	
	      write(8,formatw) rho(m),t,egn_vectors(7,1,m),t,egn_vectors(7,2,m),t,egn_vectors(7,3,m),t, &  
                         ...
                         egn_vectors(7,8,m),t,egn_vectors(7,9,m),t,egn_vectors(7,10,m),t,egn_vectors(7,11,m),t, &
                         egn_vectors(7,12,m),t,egn_vectors(7,13,m),t,egn_vectors(7,14,m) 
	end do
        close(8)					
